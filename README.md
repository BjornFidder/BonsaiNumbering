...
## Usage
The tool is a single Python script file. When installed and enabled in Blender, it loads the Numbering Tool in the UI sidebar of the 3D viewport. Assign, format, and manage numbers for IFC elements, and save/load settings as needed.
